...
param_grid = {
    'hidden_layer_sizes': [(32, 16), (50, ), (64, 32)],
    'activation': ['relu', 'tanh'],
    'alpha': [1e-4, 1e-3, 1e-2],           
    'learning_rate_init': [1e-3, 1e-2],     
}
mlp = MLPRegressor(solver='adam', max_iter=5000, random_state=13, early_stopping=True)
grid = GridSearchCV(mlp, param_grid, cv=5, scoring='r2', n_jobs=-1, verbose=0)
...
plt.title('MLP (LOOCV) Predicted v/s Actual Flux')
plt.grid(True)
plt.show()